...
def update_markdown(states, descriptions):
    ...
    for i, s in enumerate(states):
        ...
        if not desc and s == 'sStoreSetup': desc = "Store 31 uniform values to PSRAM setup store"
        ...
        if not desc and s == 'sWaitFlush': desc = "Trigger flusher: writes tile SRAM -> PSRAM"
