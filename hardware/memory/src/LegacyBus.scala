...
/** Internal legacy bus bundles, formerly imported from the old CPU module.
  *
...
/** CPU data bus — byte/halfword/word access with legacy level signaling.
  *
  ...
  * (The old CPU used this for unaligned access spanning two words).  Hutt doesn't
