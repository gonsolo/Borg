...
% LaTeX. The rect below (156.77pt,15pt)-(296.77pt,150pt) is placed at a
% fixed absolute page position specifically so the post-processing script's
% annotation rect can match it exactly; keep the two in sync if this moves.
\begin{frame}
  \titlepage
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south west] at (current page.south west) [xshift=156.77pt, yshift=15pt] {
      \includegraphics[width=140pt]{cube_frames/cube-0}
    };
  \end{tikzpicture}
\end{frame}
