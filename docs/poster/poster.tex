...
\medskip
\begin{center}
  \includegraphics[width=\linewidth]{hw_diagram}\\[0.3em]
  {\small\itshape Hardware module diagram (generated from Chisel sources)}
\end{center}
...
\begin{itemize}[leftmargin=*,nosep]
  \item \textbf{VGA/HDMI Video Output} for direct display
...
Development supported by AI-augmented pair-programming.
}
