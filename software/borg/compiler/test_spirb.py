...
if __name__ == '__main__':
    ...
    if os.path.exists(os.path.join(test_dir, "vert.spvasm")):
        test_pipeline("vert", os.path.join(test_dir, "vert.spvasm"),
                      expected_instrs=[
                          0x08101000, 0x00209004, 0x00311004, 0x00719004,
                          0x08121200, 0x20229204, 0x20331204, 0x20739204,
                          0x08141280, 0x28249284, 0x28351284, 0x28759284,
                          0x08161300, 0x30269304, 0x30371304, 0x30779304],
                      expected_unis=[0, 4, 8, 12, 1, 5, 9, 13, 2, 6, 10, 14, 3, 7, 11, 15],
    ...
    if os.path.exists(os.path.join(test_dir, "frag.spvasm")):
        test_pipeline("frag", os.path.join(test_dir, "frag.spvasm"),
                      expected_instrs=[
                          134227072, 134258688, 134291584, 137666944,
                          404758916, 403743108, 140812800, 542122500,
                          541106692, 143958656, 679486084, 678470276,
                          147104512, 816849668, 815833860, 150250368,
                          954213252, 953197444, 153396224, 1091576836,
                          1090561028
                      ],
