...
#
# Borg-specific fork of the template's pdn_cfg.tcl: dropped the trailing
# SRAM-macro PDN grid (pdn_5v_sram.tcl/pdn_3v3_sram.tcl), which unconditionally
# hardcodes `-instances i_chip_core.sram_0/1`. Borg's chip_core.sv (see
# ../../src/chip_core.sv) uses no hard SRAM macros -- all memories are
# synthesized registers/SyncReadMem (see macros_5v.yaml/macros_3v3.yaml) -- so
# sourcing the upstream SRAM PDN grid always failed OpenROAD.GeneratePDN with
# [PDN-1030] Unable to find instance: i_chip_core.sram_0.
