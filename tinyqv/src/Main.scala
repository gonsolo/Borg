...
import tinyqv.cpu.{TinyQVCpu, TinyQVCore, TinyQVCoreSnippet, TinyQVCounter, TinyQVRegisters, TinyQVAlu, TinyQVShifter, TinyQVTime, TinyQVQspiFlash, TinyQV, LatchRegN, LatchRegP, LatchReg32N, LatchReg32P, TinyQVMemCtrl, TinyQVDecode, QspiController}
...
object Main extends App {
  ...
  ChiselStage.emitSystemVerilogFile(new TinyQVCoreSnippet(), argsArray, firtoolOptsArray)
